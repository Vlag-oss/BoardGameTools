...
namespace BoardGameTools.UnitTests.Users
{
    public class RegisterCommandValidatorTests
    {
        ...
        public void Should_HaveErrorWhenEmailIsEmpty()
        {
            ...
            var command = new RegisterCommand(string.Empty, "Password123!", "Password123!");
        ...
        public void Should_HaveErrorWhenEmailIsInvalid()
        {
            //Arrange
            var validator = new RegisterCommandValidator();
            var command = new RegisterCommand("invalid-email", "Password123!", "Password123!");
        ...
        public void Should_HaveErrorWhenPasswordIsEmpty()
        {
            // Arrange
            var validator = new RegisterCommandValidator();
            var command = new RegisterCommand("test@gmail.com", string.Empty, "Password123!");
        ...
        public void Should_HaveErrorWhenPasswordDoesNotMeetCriteria(string password, string expectedErrorMessage)
        {
            // Arrange
            var validator = new RegisterCommandValidator();
            var command = new RegisterCommand("test@gmail.com", password, password);
        ...
        public void Should_HaveErrorWhenPasswordsDoNotMatch()
        {
            // Arrange
            var validator = new RegisterCommandValidator();
            var command = new RegisterCommand("test@gmail.com", "Password123!", "DifferentPassword");
